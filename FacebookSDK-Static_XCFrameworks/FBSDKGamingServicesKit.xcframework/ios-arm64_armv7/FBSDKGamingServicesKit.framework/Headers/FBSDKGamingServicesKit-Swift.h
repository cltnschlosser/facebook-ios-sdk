...
@class SwitchContextDialog;
@class FBSDKChooseContextContent;
@class FBSDKChooseContextDialog;

SWIFT_CLASS("_TtC22FBSDKGamingServicesKit27FBSDKContextDialogPresenter")
...
///
+ (FBSDKCreateContextDialog * _Nullable)createContextDialogWithContent:(FBSDKCreateContextContent * _Nonnull)content delegate:(id <FBSDKContextDialogDelegate> _Nullable)delegate SWIFT_WARN_UNUSED_RESULT;
/// Convenience method to build up and show an instant games create context dialog with content and delegate.
/// \param content The content for the create context dialog
///
/// \param delegate The receiver’s delegate.
///
+ (NSError * _Nullable)showCreateContextDialogWithContent:(FBSDKCreateContextContent * _Nonnull)content delegate:(id <FBSDKContextDialogDelegate> _Nonnull)delegate SWIFT_WARN_UNUSED_RESULT;
...
/// \param delegate The receiver’s delegate.
///
+ (SwitchContextDialog * _Nullable)switchContextDialogWithContent:(FBSDKSwitchContextContent * _Nonnull)content delegate:(id <FBSDKContextDialogDelegate> _Nullable)delegate SWIFT_WARN_UNUSED_RESULT;
/// Convenience method to build up and show an instant games switch context dialog with content and delegate.
/// \param content The content for the switch context dialog
///
/// \param delegate The receiver’s delegate.
///
+ (NSError * _Nullable)showSwitchContextDialogWithContent:(FBSDKSwitchContextContent * _Nonnull)content delegate:(id <FBSDKContextDialogDelegate> _Nullable)delegate SWIFT_WARN_UNUSED_RESULT;
...
/// \param delegate The receiver’s delegate.
///
+ (FBSDKChooseContextDialog * _Nonnull)showChooseContextDialogWithContent:(FBSDKChooseContextContent * _Nonnull)content delegate:(id <FBSDKContextDialogDelegate> _Nonnull)delegate;
...
SWIFT_CLASS("_TtC22FBSDKGamingServicesKit24FBSDKSwitchContextDialog")
@interface FBSDKSwitchContextDialog : NSObject <FBSDKWebDialogDelegate, FBSDKDialog, FBSDKShowable>
...
///   </li>
/// </ul>
+ (FBSDKSwitchContextDialog * _Nonnull)dialogWithContent:(FBSDKSwitchContextContent * _Nonnull)content windowFinder:(id <FBSDKWindowFinding> _Nonnull)windowFinder delegate:(id <FBSDKContextDialogDelegate> _Nonnull)delegate SWIFT_WARN_UNUSED_RESULT;
...
- (CGRect)createWebDialogFrameWithWidth:(CGFloat)width height:(CGFloat)height windowFinder:(id <FBSDKWindowFinding> _Nonnull)windowFinder SWIFT_WARN_UNUSED_RESULT;
